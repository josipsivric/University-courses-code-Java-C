...
public class MultiplikativniIzraz extends Cvor {
	...
	public MultiplikativniIzraz(String ime) {
		super(ime);
	}
	...
	public void provjeri() {
		String odluka;
		odluka = imenaDjece();
		if(odluka.equals("<cast_izraz>")) {
			Cvor c = djeca.get(0);
			c.provjeri();
			tip = new Tip(c.tip);
			lIzraz = c.lIzraz;
		} else if(odluka.equals("<multiplikativni_izraz>OP_PUTA<cast_izraz>") || 
				odluka.equals("<multiplikativni_izraz>OP_DIJELI<cast_izraz>") ||
				odluka.equals("<multiplikativni_izraz>OP_MOD<cast_izraz>")) {
			Cvor c0 = djeca.get(0);
			Cvor c2 = djeca.get(2);
			c0.provjeri();
