...
public class JednakosniIzraz extends Cvor {
	...
	public JednakosniIzraz(String ime) {
		super(ime);
	}
	...
	public void provjeri() {
		String odluka;
		odluka = imenaDjece();
		if(odluka.equals("<odnosni_izraz>")) {
			Cvor c = djeca.get(0);
			c.provjeri();
			tip = new Tip(c.tip);
			lIzraz = c.lIzraz;
		} else if(odluka.equals("<jednakosni_izraz>OP_EQ<odnosni_izraz>") ||
				odluka.equals("<jednakosni_izraz>OP_NEQ<odnosni_izraz>")) {
			Cvor c0 = djeca.get(0);
			Cvor c2 = djeca.get(2);
			c0.provjeri();
